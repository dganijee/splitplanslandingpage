...
export function Hero() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-white via-yellow-50/30 to-white py-20 sm:py-32 lg:pb-32 xl:pb-36">
      {/* Decorative gradient orbs */}
      <div className="absolute top-0 right-0 -z-10 h-96 w-96 rounded-full bg-yellow-400/20 blur-3xl" />
      <div className="absolute bottom-0 left-0 -z-10 h-96 w-96 rounded-full bg-yellow-300/10 blur-3xl" />
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-xl text-gray-600 leading-relaxed">
              Manage your events, track payments, and ensure everyone pays their fair share. No hassle, just SplitPlans!
            </p>
          ...
          <div className="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
            <p className="text-center text-sm font-semibold text-gray-900 lg:text-left">
              Trusted by organizers and sports teams alike.
            </p>
          </div>
        </div>
      </Container>
