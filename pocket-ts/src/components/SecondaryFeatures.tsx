...
const steps = [
  {
    name: 'STEP 1: Create Your Plan',
    description:
      'Set up your plan with a title, time, location, cost, and participants.',
    icon: DeviceArrowIcon,
  },
  {
    name: 'Step 2: Invite Your Friends',
    description:
      'Share event link via email or SMS / Whatsapp and get confirmations.',
    icon: DeviceCardsIcon,
  },
  {
    name: 'STEP 3: Split the Costs',
    description:
      "We'll handle the payment collection and ensure you get reimbursed.",
    icon: DeviceClockIcon,
  },
  {
    name: 'STEP 4: FINISH',
    description:
      'Enjoy your groups pick up basketball session, paddleball tournament, VIP booth at a club, concert, cottage trip etc. without having to worry about chasing people for funds later.',
    icon: DeviceListIcon,
  },
]
...
export function SecondaryFeatures() {
  return (
    <section
      id="how-it-works"
      aria-label="How SplitPlans Works"
